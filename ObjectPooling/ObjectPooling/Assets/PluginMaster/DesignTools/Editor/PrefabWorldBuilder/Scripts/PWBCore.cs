...
namespace PluginMaster
{
    ...
    public class PWBData
    {
        ...
        [SerializeField] private bool _undoToolProperties = true;
        ...
        public bool undoToolProperties
        {
            get => _undoToolProperties;
            set
            {
                if (_undoToolProperties == value) return;
                _undoToolProperties = value;
                Save();
            }
        }
        ...
        public static string LoadText()
        {
            ...
            else if (textAssets.Length == 1)
            {
                ...
                if (!IsDataPath(textAssets[0], out string assetPath))
