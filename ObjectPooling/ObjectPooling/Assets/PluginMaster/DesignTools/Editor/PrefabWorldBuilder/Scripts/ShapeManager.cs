...
namespace PluginMaster
{
    ...
    public class ShapeData : ISerializationCallbackReceiver
    {
        ...
        public static string HexId(long value) => "Shape_" + value.ToString("X");
    ...
    public static partial class PWBIO
    {
            ...
            if (askIfWantToSave)
            {
                void Save()
                {
                    if (SceneView.lastActiveSceneView != null)
                        ShapeStrokePreview(SceneView.lastActiveSceneView.camera);
                    CreateShape();
                }
                AskIfWantToSave((int)_shapeData.state, (int)ShapeData.ShapeState.EDIT, Save);
            }
        ...
        {
            Paint(ShapeManager.settings, PAINT_CMD, true, ShapeData.nextHexId);
        }
